...
const { name, email, message } = formData; // Destruturing form data, pulling values outside of object 

const handleChangeInput = (e) => { // e = keypress event
    ...
    <>
      ...
      <div className='app__footer-cards'>
        <div className='app__footer-card'>
          ...
          <a href="mailto:thedrucode@gmail.com" className='p-text'>thedrucode@gmail.com</a>
        </div>
        <div className='app__footer-card'>
          <img src={images.mobile} alt="mobile" />
          <a href="tel: +1 (214) 603-8503" className='p-text'>+1 (214)-603-8503</a>
        </div>
      </div>
